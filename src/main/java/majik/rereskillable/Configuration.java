...
public class Configuration
{
    ...
    static
    {
        ...
        builder.comment("List of item and block skill requirements.", "Format: mod:id skill:level", "Valid skills: attack, defense, mining, gathering, farming, building, agility, magic (plus any aliases defined in skillAliases)");
        SKILL_LOCKS = builder.defineList("skillLocks", Arrays.asList("minecraft:iron_sword attack:5", "minecraft:iron_shovel gathering:5", "minecraft:iron_pickaxe mining:5", "minecraft:iron_axe gathering:5", "minecraft:iron_hoe farming:5", "minecraft:iron_helmet defense:5", "minecraft:iron_chestplate defense:5", "minecraft:iron_leggings defense:5", "minecraft:iron_boots defense:5", "minecraft:diamond_sword attack:15", "minecraft:diamond_shovel gathering:15", "minecraft:diamond_pickaxe mining:15", "minecraft:diamond_axe gathering:15", "minecraft:diamond_hoe farming:15", "minecraft:diamond_helmet defense:15", "minecraft:diamond_chestplate defense:15", "minecraft:diamond_leggings defense:15", "minecraft:diamond_boots defense:15", "minecraft:netherite_sword attack:30", "minecraft:netherite_shovel gathering:30", "minecraft:netherite_pickaxe mining:30", "minecraft:netherite_axe gathering:30", "minecraft:netherite_hoe farming:30", "minecraft:netherite_helmet defense:30", "minecraft:netherite_chestplate defense:30", "minecraft:netherite_leggings defense:30", "minecraft:netherite_boots defense:30", "minecraft:fishing_rod gathering:5", "minecraft:shears gathering:5", "minecraft:lead farming:5", "minecraft:bow attack:5 agility:3", "minecraft:turtle_helmet defense:10", "minecraft:shield defense:5", "minecraft:crossbow attack:5 agility:5", "minecraft:trident attack:15 agility:10", "minecraft:golden_apple magic:5", "minecraft:enchanted_golden_apple magic:10", "minecraft:ender_pearl magic:5", "minecraft:ender_eye magic:10", "minecraft:piston building:5", "minecraft:sticky_piston building:10", "minecraft:tnt building:5", "minecraft:ender_chest magic:15", "minecraft:enchanting_table magic:10", "minecraft:anvil building:5", "minecraft:chipped_anvil building:5", "minecraft:damaged_anvil building:5", "minecraft:smithing_table building:10", "minecraft:end_crystal magic:20", "minecraft:boat agility:5", "minecraft:minecart agility:10", "minecraft:elytra agility:20", "minecraft:horse agility:10", "minecraft:donkey agility:10", "minecraft:mule agility:10", "minecraft:strider agility:15"), obj -> true);

        builder.comment("List of requirements to craft items.", "Format: mod:id skill:level", "Valid skills: attack, defense, mining, gathering, farming, building, agility, magic (plus any aliases defined in skillAliases)");
        CRAFT_SKILL_LOCKS = builder.defineList("craftSkillLocks", List.of(), obj -> true);

        builder.comment("List of requirements to attack entities.", "Format: mod:id skill:level", "Valid skills: attack, defense, mining, gathering, farming, building, agility, magic (plus any aliases defined in skillAliases)");
        ATTACK_SKILL_LOCKS = builder.defineList("attackSkillLocks", List.of(), obj -> true);

        builder.comment("List of substitutions to preform in names in skill lock lists.", "Useful if you're using a resource pack to change the names of skills, this config doesn't effect gameplay, just accepted values in other configs so its easier to think about", "Format: key=value", "Valid values: attack, defense, mining, gathering, farming, building, agility, magic");
